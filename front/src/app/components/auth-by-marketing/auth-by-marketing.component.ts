...
@Component({
  selector: 'app-auth-by-marketing',
  templateUrl: './auth-by-marketing.component.html',
  styleUrls: ['./auth-by-marketing.component.scss']
})
export class AuthByMarketingComponent implements OnInit {
  ...
  onSubmitForm() {
    ...
    this.userService.loginbyMarketing(formValue["email"], formValue["password"]).subscribe((data) => {
      if (data == null) {
